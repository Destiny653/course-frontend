                        ...
                        <div className='flex justify-evenly items-center gap-[1px] w-full'>
                            ...
                            <form onSubmit={handleSubmit} className='box-border flex flex-col justify-center items-center gap-[20px] form-reg px-[20px] w-[40%]' action="http://localhost:3000/api/auth/student" method='post'>
                                ...
                                <label htmlFor="enrollement data">
                                    ...
                                    <input className='border-[1px] px-[20px] py-[9px] rounded-[10px] w-[350px] text-[#000] outline-none' type="date" id="enrollement data" name="enrollement data" placeholder="Enrollement Data" value={enrollementDate} onChange={(e) => setEnrollementDate(e.target.value)} />
                                </label>
                                <label htmlFor="enrollement data">
                                    <span className='text-[#000]'>Date of Birth</span>
                                    <input className='border-[1px] px-[20px] py-[9px] rounded-[10px] w-[350px] text-[#000] outline-none' type="date" id="enrollement data" name="enrollement data" placeholder="Date of birth" value={dateOfBirth} onChange={(e) => setDateOfBirth(e.target.value)} />
                                </label>
